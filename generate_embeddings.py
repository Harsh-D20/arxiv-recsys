...
if __name__ == "__main__":
    # This should match the output file generated by data_loader.py
    TARGET_PARQUET_FILE = "filtered_arxiv_papers.parquet"
    
    print(f"Starting embedding generation pipeline for {TARGET_PARQUET_FILE}...")
    generate_embeddings(TARGET_PARQUET_FILE)